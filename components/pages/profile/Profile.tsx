...
const Profile = ({
  ...
  const removeFromCloseFriends = async (
    userId: string | undefined,
    friendId: string | undefined
  ) => {
    if (!userId || !friendId) {
                  ...
                  <Tooltip>
                    <TooltipTrigger>
                      <Link
                        ...
                        className="text-[#6439FF] dark:text-custom-200 absolute top-1 -right-7"
                      >
                        <Star
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger>
                      ...
                      >
                        <Star
                          className="text-yellow-200 hover:text-yellow-400 fill-yellow-200 hover:fill-yellow-400"
                          size={20}
                        />
                      </Link>
                    </TooltipTrigger>
