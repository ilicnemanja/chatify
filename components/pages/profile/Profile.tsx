    ...
    <div className='overflow-hidden'>
      <div className="flex flex-col items-center gap-4">
        <div className="w-20 h-20 overflow-hidden rounded-full">
          {user.profilePicture && <Image src={user.profilePicture} alt="Profile Picture" className="object-cover" width={80} height={80} />}
        ...
        {user?.lastActive && <p className="text-gray-400 dark:text-neutral-100 text-sm font-sour-gummy">last active {formatDateWithTime(user.lastActive)}</p>}
      </div>
